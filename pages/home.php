...
<div class="home-page">
    ...
    <section class="hero-section">
        <div class="hero-content">
            <div class="hero-badge">
                ...
                <span>Rental Mobil Kansei Rental Premium</span>
            </div>
            <h1 class="hero-title">
                Temukan Mobil <span class="highlight">Kansei Rental Impian</span> Anda
            </h1>
    ...
    <section class="steps-section">
        ...
        <div class="steps-grid">
            ...
            <div class="step-card">
                ...
                <h3>Pilih Mobil</h3>
                <p>Jelajahi koleksi mobil Kansei Rental kami dan pilih yang sesuai kebutuhan.</p>
            </div>
            <div class="step-card">
    ...
    <section class="cta-section">
        <div class="cta-content">
            <h2>Siap Untuk Rental Mobil Kansei Rental?</h2>
